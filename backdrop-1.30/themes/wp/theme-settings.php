...
function wp_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['wp_settings']['wp_active_theme'] = array(
    ...
    '#description' => t('Select which WordPress theme to use for displaying content. Themes must be placed in the wpbrain/wp-content/themes directory.'),
  ...
  $form['wp_settings']['info'] = array(
    '#markup' => '<div class="description">' .
      ...
      '<li>Themes should be placed in: <code>themes/wp/wpbrain/wp-content/themes/</code></li>' .
